...
class WidgetVoice extends Component<Props, State> {
    state = {
        recognized: '',
        pitch: '',
        error: '',
    ...
    render() {
        return (
            <View style={styles.container}>
                ...
                <TextInput
                    tw="border border-s-200 bg-s-50 w-full"
                    multiline={true}
                    numberOfLines={4}
                ...
                <TouchableHighlight onPress={this._startRecognizing}>
                    ...
                    <Text tw="p-6">start</Text>
                </TouchableHighlight>
                <TouchableHighlight onPress={this._stopRecognizing}>
                    <Text tw="p-6">stop</Text>
