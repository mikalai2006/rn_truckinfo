...
const WidgetNodeRatingShort = (props: Props) => {
        ...
        <View>
            <>
                <TouchableOpacity
                    ...
                    onPress={() =>
                        navigation.navigate('ReviewScreen', {lid: localNode?._id.toHexString(), serverNode})
                    }>
            ...
            {serverNode?.osmId ? () : (
                <View>
                    <SSkeleton classString="h-8 mt-2" text="Load reviews" />
                </View>
            )} */}
        </View>
    );
